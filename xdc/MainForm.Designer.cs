namespace xdc
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.closeAllToolStripMenuItem.Click += new System.EventHandler(this.closeAllStripMenuItem_Click);
			// 
			...
			this.dockPanel.DockBottomPortion = 0.19999999999999996D;
			this.dockPanel.DockTopPortion = 0.8D;
